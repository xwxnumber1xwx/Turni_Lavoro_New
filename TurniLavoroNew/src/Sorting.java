...
public class Sorting {
	...
	public static  ArrayList<Employee> SortingNightTariffLessToHigh(ArrayList<Employee> dipendenti){
		...
		Collections.sort(dipendenti, new Comparator<Employee>() {
			@Override
			public int compare(Employee dipendenti2, Employee dipendenti1) //mi ritorna -1,0 o 1 se dipendenti1.gerOreNotturne è minore uguale o maggiore di dipendenti2.getOreNotturne
			{
