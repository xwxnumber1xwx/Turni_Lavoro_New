...
public class Turni {
	...
	/*	double oreNotturne [][] = { //DEPRECATED
		...
		*/
		...
		LocalTime domNach_Fine = LocalTime.of(Integer.parseInt(Preferenze.getOnePreference("NACHT_DOM_FINE_H")), Integer.parseInt(Preferenze.getOnePreference("NACHT_DOM_FINE_M")));
