...
public class Employee implements Serializable {
	...
	String surname;
	int rank = 0;
	int workLine = 0; // 1 = linea 1, 2 = linea 2, 3 = entrambe
	int lineLeader = 0;
	...
	/*
	 * public void setDayOffLD (LocalDate dayOffLD) { this.dayOffLD = dayOffLD; }
	 * public LocalDate getDayOffLD() { return dayOffLD; }
	 */
	...
	public void setTime(LocalDate date, LocalTime dayLT, int dayINT) {
		switch (dayINT) {
		case 0:
			this.Sunday = LocalDateTime.of(date, dayLT);
			break;

		case 1:
			this.Monday = LocalDateTime.of(date, dayLT);
			break;

		case 2:
			this.Tuesday = LocalDateTime.of(date, dayLT);
			break;

		case 3:
			this.Wednesday = LocalDateTime.of(date, dayLT);
			break;

		case 4:
			this.Thursday = LocalDateTime.of(date, dayLT);
			break;

		case 5:
			this.Friday = LocalDateTime.of(date, dayLT);
			break;

		case 6:
			this.Saturday = LocalDateTime.of(date, dayLT);
			break;
		}
	}
	...
	public static void main(String[] args) {
		Gson gson = new Gson();
		gson.toJson(new Employee());
		Employee fromJson = gson.fromJson(
				"{\"name\":\"pino\",\"employeeCode\":0,\"rank\":0,\"workLine\":0,\"lineLeader\":0,\"shiftLine\":0,\"shiftLineLeader\":0,\"onlyMorning\":false,\"dayOffThisWeek\":false,\"holidayThisWeek\":false,\"nightRate\":0.0,\"holidayRate\":0.0,\"sundayRate\":0.0,\"sicknessDays\":0,\"disease\":false,\"allNightRates\":0.0,\"dayOff\":0,\"morningNight\":1,\"weekShift\":[],\"Saturday\":{\"date\":{\"year\":-999999999,\"month\":1,\"day\":1},\"time\":{\"hour\":0,\"minute\":0,\"second\":0,\"nano\":0}}}",
				Employee.class);
